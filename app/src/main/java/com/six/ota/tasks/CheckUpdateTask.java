...
import com.six.ota.MainActivity;
import com.six.ota.R;
import com.six.ota.configs.AppConfig;
import com.six.ota.configs.LinkConfig;
import com.six.ota.configs.OTAConfig;
import com.six.ota.configs.OTAVersion;
import com.six.ota.dialogs.WaitDialogHandler;
import com.six.ota.utils.OTAUtils;
import com.six.ota.xml.OTADevice;
import com.six.ota.xml.OTAParser;
...
public class CheckUpdateTask extends AsyncTask<Context, Void, OTADevice> {
    ...
    private void showNotification(Context context) {
        if (mIsBackgroundThread) {
            ...
            int notifyID = 1;
            String id = "sixota_channel";
            CharSequence name = context.getString(R.string.six_channel);
            String description = context.getString(R.string.six_channel_description);
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context.getApplicationContext())
                    .setSmallIcon(R.drawable.ic_notification_six)
